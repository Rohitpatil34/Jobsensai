...
const AiInterview = () => {
    ...
    return (
        <motion.div
            className=" mx-auto mt-16 p-6 min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100"
        ...
        >
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-transparent bg-clip-text mb-3">
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        {/* Job Description */}
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text mb-4 flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
